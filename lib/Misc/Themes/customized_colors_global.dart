...
import '../Themes/pattern_colors.dart';

class CustomizedColors {
  //Texto
  static Color blueText = PatternColors.fluorescentBlue;
  static Color darkBlueText = PatternColors.absoluteZero;
  ...
  static Color darkBlueBackground = PatternColors.absoluteZero;
  ...
  static Color darkBlueIcon = PatternColors.absoluteZero;
